...
<head>
    ...
    <link rel="icon" href="{{ url('img/thienhunglogo.png') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('css/templatemo-upright.css') }}">
                ...
                <nav class="tm-nav">
                    ...
                    <div>
                        <div class="tm-brand-box" >
                            <img src="img/thienhunglogo.png" width="180px" height="180px" >
                            {{-- <h1 class="tm-brand">Thiên Hưng</h1> --}}
                        </div>                
                        <ul id="tm-main-nav">
                            <li class="nav-item">                                
            ...
            <div class="tm-main">
                ...
                <div class="tm-section-wrap">
                    ...
                    <section id="home" class="tm-section">
                        <h2 class="tm-text-primary">Chào mừng bạn đến với Thiên Hưng</h2>
                        <hr class="mb-5">
                        <div class="row">
                            <div class="col-lg-6 tm-col-home mb-4">
                                <div class="tm-text-container">
                                    <div class="tm-icon-container mb-5 mr-0 ml-auto">
                                        <img src="img/homeimage1.jpg" width="550" height="200">
                                    </div>                                
                                    <p>
                                        Nắm bắt được nhu cầu khách hàng, Thiên Hưng không ngừng nổ lực để mang đến những sản phẩm pháp lý rỏ ràng cùng với chất lượng sản phẩm tốt nhất để khởi nguồn cuộc sống tốt đẹp và nâng cao giá trị cuộc sống cho cộng đồng.
                                    </p>
                                </div>                                
                            </div>
                            <div class="col-lg-6 tm-col-home mb-4">
                                <div class="tm-text-container">
                                    <div class="tm-icon-container mb-5 mr-0 ml-auto">
                                        <img src="img/homeimage2.jpg" width="550" height="200">
                                    </div>                                 
                                    <p>
                                        Với đội ngũ nhân viên chuyên nghiệp, tận tâm, giàu kinh nghiệm, đã tạo nên một chuỗi giá trị dịch vụ khách hàng và giải pháp bán hàng hoàn chỉnh, góp phần làm gia tăng giao dịch cho khách hàng đã đầu tư sản phẩm từ Thiên Hưng.
                                    </p>
                                    <div class="text-right">
                                        <a href="#gallery" class="btn btn-primary tm-btn-next">Xem thêm</a>
                                    </div>                                    
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row tm-row-home">                            
                            <div class="tm-col-home tm-col-home-l">
                                <div class="media mb-4">
                                    <i class="fas fa-check-circle fa-4x tm-post-icon tm-text-primary"></i>
                                    <div class="media-body">
                                        <a href="#" class="d-block mb-2 tm-text-primary tm-post-link">Sứ mệnh</a>  
                                        <p>
                                            Xây dựng Tập đoàn Thiên Hưng thành một Công ty kinh doanh Bất động sản hàng đầu Việt Nam, một thương hiệu mạnh được xã hội công nhận và suy tôn. </p>
                                    </div>                                    
                                </div>
                                <div class="media mb-4">
                                    <i class="fas fa-check-circle fa-4x tm-post-icon tm-text-primary"></i>
                                    <div class="media-body">
                                        <a href="#" class="d-block mb-2 tm-text-primary tm-post-link">Tầm Nhìn</a>  
                                        <p>
                                            Tạo dựng những giá trị tốt đẹp nhất cho cộng đồng về:<br>
                                                - Môi trường sống.<br>
                                ...
                                <div class="media mb-4">
                                    <i class="fas fa-check-circle fa-4x tm-post-icon tm-text-primary"></i>
                                    <div class="media-body">
                                        <a href="#" class="d-block mb-2 tm-text-primary tm-post-link">Giá trị cốt lõi</a>  
                                        <p>
                                            Tiềm năng sinh lời đột phá từ các dự án do tập đoàn Bất Động Sản Thiên Hưng làm chủ đầu tư. Lấy lợi ích xã hội làm mục tiêu, uy tín hàng đầu khu vực làm điểm đến, các dự án của Thiên Hưng Group đều sẽ là tâm điểm của thị trường bất động sản trong khu vực đem lại tiềm năng lớn cho việc an cư lâu dài cũng như đầu tư siêu lợi nhuận.
                                        </p>
                                    </div>                                    
                                </div>
                            </div>
